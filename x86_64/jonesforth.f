...
\<------------------------------------------------------------------------------------------------------------------------>
\
\	Ported to x86_64 by aushacker. All credit is Richard's.
\       March 2023.
\
\<------------------------------------------------------------------------------------------------------------------------>
\
...
\ x86_64, the idiv instruction gives both anyway).  Now we can define the / and MOD in terms of /MOD
...
(
	...
	S0+8 points to argv[0], S0+16 points to argv[1] etc up to argv[argc-1].
